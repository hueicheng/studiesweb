...
$(function(){
	$("#toolbar a").click(usingBtn);
	$('div.drag').mousedown(selectedWindow);
	/*
...
function addCanvas(x,y){
  ...
  */
	...
	$('#canvasPaper').append(
		...
		'<canvas class="workarea" width="'+ 500 +'" height="'+ 500 +'"></canvas></div>'
	);
	$('div.drag').mousedown(selectedWindow);
  focus();
}
...
function usingBtn(){
	...
	var btns = document.getElementById("toolbar").getElementsByTagName("dd");
